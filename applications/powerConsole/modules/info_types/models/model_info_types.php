...
require_once "applications/powerConsole/modules/info_types/models/table_info_types.php";

class info_typesModel extends modelBase {

    var $tables="info_types";

    function __construct($dataRep, $config,&$incomingModels=array()) {
        parent::__construct($dataRep, $config,$incomingModels);
        $table=new table_info_types();
