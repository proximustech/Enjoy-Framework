...
require_once "applications/powerConsole/modules/processes/models/table_processes.php";

class processesModel extends modelBase {

    var $tables="processes";

    function __construct($dataRep, $config,&$incomingModels=array()) {
        parent::__construct($dataRep, $config,$incomingModels);
        $table=new table_processes();
